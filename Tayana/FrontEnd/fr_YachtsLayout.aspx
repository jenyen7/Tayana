<%@ Page Title="" Language="C#" MasterPageFile="~/FrontEnd/frontLayaout.Master" AutoEventWireup="true" CodeBehind="fr_YachtsLayout.aspx.cs" Inherits="Tayana.WebForm17" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="Left_NavBar" runat="server">
    ...
    <ul>
        <asp:Repeater ID="YachtsList_rpt" runat="server">
            <ItemTemplate>
                <li><a href='fr_YachtsLayout.aspx?id=<%#Eval("id") %>'><%#Eval("yachtName") %>
    ...
    <div class="right">
        <div class="right1">
            ...
            <div class="box6">
                ...
                <asp:Literal ID="layout" runat="server"></asp:Literal>
            </div>
            <div class="clear">
            </div>
            <!--------------------------------內容結束------------------------------------------------------>
