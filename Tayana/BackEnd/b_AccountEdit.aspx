<%@ Page Title="" Language="C#" MasterPageFile="~/BackEnd/backLayout.Master" AutoEventWireup="true" CodeBehind="b_AccountEdit.aspx.cs" Inherits="Tayana.WebForm36" %>
    ...
    <div class="col-sm-12">
        <div class="page-header card">
            <div class="card-block" style="position: relative">
                <h4 class="mb-10" style="color: #546D77">編輯管理者帳號</h4>
                <div style="position: absolute; right: 30px; top: 30px">
                    <asp:LinkButton ID="BackToListBtn" runat="server" CssClass="btn btn-round adjust-btn" OnClick="BackToListBtn_Click" OnClientClick="javascript:if(!window.confirm('您即將離開此頁面，已填寫的資料如果尚未儲存將會遺失，確定要離開嗎?')) window.event.returnValue = false;"><i class="ti-back-right"></i>返回帳號列表</asp:LinkButton>
                </div>
                <p class="text-muted f-16">
                    每個管理者可以有不同的權限，請記得設置權限。
                </p>
                <ul class="breadcrumb-title b-t-default p-t-10">
                    ...
                    <li class="breadcrumb-item"><a href="b_AccountsList.aspx" onclick="javascript:if(!window.confirm('您即將離開此頁面，已填寫的資料如果尚未儲存將會遺失，確定要離開嗎?')) window.event.returnValue = false;">管理帳號列表</a>
                    </li>
                    <li class="breadcrumb-item"><a href="#!">編輯管理者帳號</a>
                    </li>
                </ul>
                <br />
            ...
            <div class="card-block">
                ...
                <div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-5">
                            <asp:TextBox ID="password" runat="server" CssClass="form-control" placeholder="密碼至少要五位數喔" TextMode="Password"></asp:TextBox>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-sm-2 col-form-label fontsize-16">確認密碼</label>
                        <div class="col-sm-5">
                            <asp:TextBox ID="confirmPassword" runat="server" CssClass="form-control" placeholder="請再次輸入密碼" TextMode="Password"></asp:TextBox>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-sm-2 col-form-label"></label>
                        <div class="col-sm-5">
                            <input type="checkbox" onclick="myFunction()">&nbsp 顯示密碼
                        ...
                        <div class="col-sm-5" style="margin-top: 5px">
                            <div class="d-flex justify-content-between" style="margin-bottom: 10px">
                                <div>
                                    ...
                                    <span class="adjust-text" style="color: #546D77">管理帳號</span>
                                </div>
                            </div>
                            <div class="d-flex justify-content-between" style="margin-bottom: 10px">
                                <div>
                                    ...
                                    <span class="adjust-text" style="color: #546D77">管理遊艇型號</span>
                                    <%--#2196F3--%>
                                </div>
                                <div>
                                    <label class="switch">
                                    ...
                                    <span class="adjust-text" style="color: #546D77">管理代理商列表</span>
                                    <%--#FFB92B--%>
                                </div>
                            </div>
                            <div class="d-flex justify-content-between" style="margin-bottom: 10px">
                                <div>
                                    ...
                                    <span class="adjust-text" style="color: #546D77">管理新聞列表</span>
                                    <%--#8F41FB--%>
                                </div>
                                <div>
                                    <label class="switch">
                                        <asp:CheckBox ID="AuthMessages" runat="server" />
                                        <span class="slider slider5"></span>
                                    </label>
                                    <span class="adjust-text" style="color: #546D77">管理留言區列表</span>
                                    <%--#54D98C--%>
                                </div>
                            </div>
                        </div>
                ...
                <div class="d-flex justify-content-end">
                    <asp:Button ID="editAccountBtn" runat="server" Text="儲存" CssClass="btn btn-round adjust-addbtn" OnClick="editAccountBtn_Click" />
