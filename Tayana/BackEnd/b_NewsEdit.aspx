<%@ Page Title="" Language="C#" Debug="true" MasterPageFile="~/BackEnd/backLayout.Master" AutoEventWireup="true" CodeBehind="b_NewsEdit.aspx.cs" Inherits="Tayana.WebForm4" ValidateRequest="False" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        window.onload = function () {
            var imgvalue = document.all('ContentPlaceHolder1_hidCoverPic').value;
            ////var imgvalue = document.getElementById("<%=hidCoverPic.ClientID %>").value;
            document.getElementById('picPreview').innerHTML = '<img src="../assets_tayana/upload/Images/' + imgvalue + '" style="width:240px;height:200px;" />';
        }
        function preview(file) {
            ...
            if (file.files && file.files[0]) {
                ...
                var imgvalue = document.all('ContentPlaceHolder1_hidCoverPic').value;
                preview_div.innerHTML = '<img src="../assets_tayana/upload/Images/' + imgvalue + '" style="width:240px;height:200px;" />';
            }
        }
    </script>
    ...
    <div class="col-sm-12">
        <div class="page-header card">
            <div class="card-block" style="position: relative">
                <h4 class="mb-10" style="color: #546D77">新聞編輯</h4>
                <div style="position: absolute; right: 30px; top: 30px">
                    <asp:LinkButton ID="BackToListBtn" runat="server" CssClass="btn btn-round adjust-btn" OnClick="BackToListBtn_Click" OnClientClick="javascript:if(!window.confirm('您即將離開此頁面，已填寫的資料將會遺失，您確定要離開嗎?')) window.event.returnValue = false;"><i class="ti-back-right"></i>返回新聞列表</asp:LinkButton>
                </div>
                ...
                <ul class="breadcrumb-title b-t-default p-t-10">
                    ...
                    <li class="breadcrumb-item"><a href="#!">新聞編輯</a>
                    </li>
                </ul>
                <br />
    ...
    <div class="col-sm-12">
        <div class="card">
            <div class="card-block">
                <h4 class="sub-title">編輯新聞封面簡介</h4>
                ...
                <div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-5 button-wrap">
                            ...
                            <asp:FileUpload ID="newsCoverPic" runat="server" CssClass="form-control" onchange="preview(this)" />
                            ...
                            <asp:HiddenField ID="hidCoverPic" runat="server" />
                        </div>
                    </div>
                </div>
            </div>
            <div class="card-block">
                <h4 class="sub-title">編輯新聞內部文章&nbsp<span style="color: darkcyan">( 上傳圖片建議的寬度為710以內 )</span>
                    <asp:Label ID="check_newsContent" runat="server" ForeColor="Red" Font-Size="16px"></asp:Label></h4>
                <asp:TextBox ID="newsContent" runat="server" TextMode="MultiLine" Width="600px"></asp:TextBox><br />
                <div class="d-flex justify-content-end">
                    <asp:Button ID="EditNews" runat="server" Text="儲存" CssClass="btn btn-round btn-success font-weight-bold fontsize-18" OnClick="EditNews_Click" />
                </div>
            </div>
        </div>
    </div>
