<%@ Page Title="" Language="C#" MasterPageFile="~/BackEnd/backLayout.Master" AutoEventWireup="true" CodeBehind="b_DealersAdd.aspx.cs" Inherits="Tayana.WebForm10" %>
    ...
    <div class="col-sm-10">
        <div class="page-header card">
            <div class="card-block" style="position: relative">
                <h4 class="mb-10" style="color: #546D77">新增代理商</h4>
                ...
                <ul class="breadcrumb-title b-t-default p-t-10">
                    ...
                    <li class="breadcrumb-item"><a href="#!">新增代理商</a>
                    </li>
                </ul>
                <br />
    ...
    <div class="col-sm-10">
        <div class="card">
            <div class="card-block">
                <h4 class="sub-title">請輸入代理商資料 &nbsp<span style="color: red">*必填</span></h4>
                <div>
                    <div class="form-group row">
                        <label class="col-sm-2 col-form-label">代理商所屬區域*</label>
                        <div class="col-sm-4">
                            <asp:DropDownList ID="DDLcountries" runat="server" CssClass="form-control" required="" AutoPostBack="true" OnSelectedIndexChanged="DDLcountries_SelectedIndexChanged"></asp:DropDownList>
                        </div>
                        <div class="col-sm-4">
                            <asp:DropDownList ID="DDLcities" runat="server" CssClass="form-control" required=""></asp:DropDownList>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8 button-wrap">
                            ...
                            <asp:FileUpload ID="dealersPic" runat="server" CssClass="form-control" onchange="preview(this)" required="" />
                            <div id="picPreview" style="margin-top: 20px">代理商封面圖預覽</div>
                            <asp:Label ID="lblmessage" runat="server" ForeColor="Red"></asp:Label>
                        </div>
                    </div>
                    <div class="d-flex justify-content-end">
                        <asp:Button ID="AddDealerBtn" runat="server" Text="送出" CssClass="btn btn-round btn-warning font-weight-bold fontsize-18" OnClick="AddDealerBtn_Click" />
